...
FOSSIL_TEST_GROUP(cpp_pqueue_tofu_tests) {    
    ...
    FOSSIL_ADD_TEST(cpp_pqueue_tofu_fixture, cpp_test_pqueue_create_container_and_destroy);
    FOSSIL_ADD_TEST(cpp_pqueue_tofu_fixture, cpp_test_pqueue_insert_and_remove);
    FOSSIL_ADD_TEST(cpp_pqueue_tofu_fixture, cpp_test_pqueue_create_copy);
    FOSSIL_ADD_TEST(cpp_pqueue_tofu_fixture, cpp_test_pqueue_create_move);
    FOSSIL_ADD_TEST(cpp_pqueue_tofu_fixture, cpp_test_pqueue_not_empty_and_is_empty);
    FOSSIL_ADD_TEST(cpp_pqueue_tofu_fixture, cpp_test_pqueue_not_cnullptr_and_is_cnullptr);
    FOSSIL_ADD_TEST(cpp_pqueue_tofu_fixture, cpp_test_pqueue_set_front_and_set_back);
    FOSSIL_ADD_TEST(cpp_pqueue_tofu_fixture, cpp_test_pqueue_get_front_and_get_back_empty);
    FOSSIL_ADD_TEST(cpp_pqueue_tofu_fixture, cpp_test_pqueue_remove_empty);
    FOSSIL_ADD_TEST(cpp_pqueue_tofu_fixture, cpp_test_pqueue_size_consistency);

    // Register the test group
    FOSSIL_ADD_SUITE(cpp_pqueue_tofu_fixture);
} // end of tests
