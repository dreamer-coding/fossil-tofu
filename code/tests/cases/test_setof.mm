...
FOSSIL_SUITE(objcpp_setof_tofu_fixture);

FOSSIL_SETUP(objcpp_setof_tofu_fixture) {
    // Setup the test fixture
}

FOSSIL_TEARDOWN(objcpp_setof_tofu_fixture) {
...
FOSSIL_TEST(objcpp_test_setof_create_and_destroy) {
    SetOf set("i32");
    ASSUME_ITS_EQUAL_I32(set.size(), 0);
}

FOSSIL_TEST(objcpp_test_setof_insert_and_contains) {
    SetOf set("i32");
    set.insert("10");
...
FOSSIL_TEST(objcpp_test_setof_remove) {
    SetOf set("i32");
    set.insert("20");
    set.insert("30");
...
FOSSIL_TEST(objcpp_test_setof_is_empty_and_not_empty) {
    SetOf set("i32");
...
FOSSIL_TEST(objcpp_test_setof_insert_duplicate) {
    SetOf set("i32");
    set.insert("55");
...
FOSSIL_TEST(objcpp_test_setof_remove_nonexistent) {
    SetOf set("i32");
    set.insert("77");
    try {
        set.remove("88");
