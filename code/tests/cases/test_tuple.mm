...
FOSSIL_TEST_GROUP(objcpp_tuple_tofu_tests) {    
    ...
    FOSSIL_ADD_TEST(objcpp_tuple_tofu_fixture, objcpp_test_tuple_create_and_destroy);
    FOSSIL_ADD_TEST(objcpp_tuple_tofu_fixture, objcpp_test_tuple_create_default);
    FOSSIL_ADD_TEST(objcpp_tuple_tofu_fixture, objcpp_test_tuple_add_and_get);
    FOSSIL_ADD_TEST(objcpp_tuple_tofu_fixture, objcpp_test_tuple_get_front_and_back);
    FOSSIL_ADD_TEST(objcpp_tuple_tofu_fixture, objcpp_test_tuple_set_and_get);
    FOSSIL_ADD_TEST(objcpp_tuple_tofu_fixture, objcpp_test_tuple_remove);
    FOSSIL_ADD_TEST(objcpp_tuple_tofu_fixture, objcpp_test_tuple_clear_and_is_empty);
    FOSSIL_ADD_TEST(objcpp_tuple_tofu_fixture, objcpp_test_tuple_capacity_growth);
    FOSSIL_ADD_TEST(objcpp_tuple_tofu_fixture, objcpp_test_tuple_copy_constructor);
    FOSSIL_ADD_TEST(objcpp_tuple_tofu_fixture, objcpp_test_tuple_move_constructor);

    // Register the test group
    FOSSIL_ADD_SUITE(objcpp_tuple_tofu_fixture);
} // end of tests
