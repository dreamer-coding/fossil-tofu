...
FOSSIL_SUITE(objcpp_tuple_tofu_fixture);

FOSSIL_SETUP(objcpp_tuple_tofu_fixture) {
    // Setup the test fixture
}

FOSSIL_TEARDOWN(objcpp_tuple_tofu_fixture) {
...
FOSSIL_TEST(objcpp_test_tuple_create_and_destroy) {
    Tuple tuple("i32");
    ASSUME_ITS_EQUAL_I32(tuple.size(), 0);
}

FOSSIL_TEST(objcpp_test_tuple_create_default) {
    Tuple tuple;
    ASSUME_ITS_EQUAL_I32(tuple.size(), 0);
}

FOSSIL_TEST(objcpp_test_tuple_add_and_get) {
    Tuple tuple("i32");
    tuple.add("10");
    tuple.add("20");
    tuple.add("30");
...
FOSSIL_TEST(objcpp_test_tuple_capacity_growth) {
    Tuple tuple("i32");
...
FOSSIL_TEST(objcpp_test_tuple_copy_constructor) {
    Tuple tuple1("i32");
    tuple1.add("1");
    tuple1.add("2");
    Tuple tuple2 = tuple1;
...
// * * * * * * * * * * * * * * * * * * * * * * * *
FOSSIL_TEST_GROUP(objcpp_tuple_tofu_tests) {    
    // Generic ToFu Fixture
    FOSSIL_TEST_ADD(objcpp_tuple_tofu_fixture, objcpp_test_tuple_create_and_destroy);
    FOSSIL_TEST_ADD(objcpp_tuple_tofu_fixture, objcpp_test_tuple_create_default);
    FOSSIL_TEST_ADD(objcpp_tuple_tofu_fixture, objcpp_test_tuple_add_and_get);
    FOSSIL_TEST_ADD(objcpp_tuple_tofu_fixture, objcpp_test_tuple_get_front_and_back);
    FOSSIL_TEST_ADD(objcpp_tuple_tofu_fixture, objcpp_test_tuple_set_and_get);
    FOSSIL_TEST_ADD(objcpp_tuple_tofu_fixture, objcpp_test_tuple_remove);
    FOSSIL_TEST_ADD(objcpp_tuple_tofu_fixture, objcpp_test_tuple_clear_and_is_empty);
    FOSSIL_TEST_ADD(objcpp_tuple_tofu_fixture, objcpp_test_tuple_capacity_growth);
    FOSSIL_TEST_ADD(objcpp_tuple_tofu_fixture, objcpp_test_tuple_copy_constructor);
    FOSSIL_TEST_ADD(objcpp_tuple_tofu_fixture, objcpp_test_tuple_move_constructor);

    // Register the test group
    FOSSIL_TEST_REGISTER(objcpp_tuple_tofu_fixture);
} // end of tests
