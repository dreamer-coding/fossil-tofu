...
FOSSIL_TEST_GROUP(objcpp_clist_tofu_tests) {    
    // clist ToFu Fixture
    FOSSIL_ADD_TEST(objcpp_clist_tofu_fixture, objcpp_test_clist_create_and_destroy);
    FOSSIL_ADD_TEST(objcpp_clist_tofu_fixture, objcpp_test_clist_create_default);
    FOSSIL_ADD_TEST(objcpp_clist_tofu_fixture, objcpp_test_clist_insert_and_size);
    FOSSIL_ADD_TEST(objcpp_clist_tofu_fixture, objcpp_test_clist_remove);
    FOSSIL_ADD_TEST(objcpp_clist_tofu_fixture, objcpp_test_clist_reverse);
    FOSSIL_ADD_TEST(objcpp_clist_tofu_fixture, objcpp_test_clist_get_and_set);
    FOSSIL_ADD_TEST(objcpp_clist_tofu_fixture, objcpp_test_clist_get_front_and_back);
    FOSSIL_ADD_TEST(objcpp_clist_tofu_fixture, objcpp_test_clist_set_front_and_back);
    FOSSIL_ADD_TEST(objcpp_clist_tofu_fixture, objcpp_test_clist_copy_and_move);
    FOSSIL_ADD_TEST(objcpp_clist_tofu_fixture, objcpp_test_clist_empty_and_null_checks);

    // Register the test group
    FOSSIL_ADD_SUITE(objcpp_clist_tofu_fixture);
} // end of tests
