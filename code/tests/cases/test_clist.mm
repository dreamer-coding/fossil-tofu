...
FOSSIL_SUITE(objcpp_clist_tofu_fixture);

FOSSIL_SETUP(objcpp_clist_tofu_fixture) {
    // Setup the test fixture
}

FOSSIL_TEARDOWN(objcpp_clist_tofu_fixture) {
...
FOSSIL_TEST(objcpp_test_clist_create_and_destroy) {
    CList clist("i32");
    ASSUME_ITS_TRUE(clist.not_cnullptr());
    ASSUME_ITS_TRUE(clist.is_empty());
}

FOSSIL_TEST(objcpp_test_clist_create_default) {
    CList clist;
    ASSUME_ITS_TRUE(clist.not_cnullptr());
...
FOSSIL_TEST(objcpp_test_clist_insert_and_size) {
    CList clist("i32");
...
FOSSIL_TEST(objcpp_test_clist_remove) {
    CList clist("i32");
    clist.insert("1");
    clist.insert("2");
    clist.insert("3");
...
FOSSIL_TEST(objcpp_test_clist_reverse) {
    CList clist("i32");
    clist.insert("A");
    clist.insert("B");
    clist.insert("C");
...
FOSSIL_TEST(objcpp_test_clist_get_and_set) {
    CList clist("i32");
    clist.insert("100");
    clist.insert("200");
    clist.insert("300");
...
FOSSIL_TEST(objcpp_test_clist_get_front_and_back) {
    CList clist("i32");
    clist.insert("first");
    clist.insert("middle");
    clist.insert("last");
...
FOSSIL_TEST(objcpp_test_clist_set_front_and_back) {
    CList clist("i32");
    clist.insert("one");
    clist.insert("two");
    clist.insert("three");
...
FOSSIL_TEST(objcpp_test_clist_copy_and_move) {
    CList clist1("i32");
    clist1.insert("5");
    clist1.insert("10");
    clist1.insert("15");
...
FOSSIL_TEST(objcpp_test_clist_empty_and_null_checks) {
    CList* clist = nullptr;
...
// * * * * * * * * * * * * * * * * * * * * * * * *
FOSSIL_TEST_GROUP(objcpp_clist_tofu_tests) {    
    // clist ToFu Fixture
    FOSSIL_TEST_ADD(objcpp_clist_tofu_fixture, objcpp_test_clist_create_and_destroy);
    FOSSIL_TEST_ADD(objcpp_clist_tofu_fixture, objcpp_test_clist_create_default);
    FOSSIL_TEST_ADD(objcpp_clist_tofu_fixture, objcpp_test_clist_insert_and_size);
    FOSSIL_TEST_ADD(objcpp_clist_tofu_fixture, objcpp_test_clist_remove);
    FOSSIL_TEST_ADD(objcpp_clist_tofu_fixture, objcpp_test_clist_reverse);
    FOSSIL_TEST_ADD(objcpp_clist_tofu_fixture, objcpp_test_clist_get_and_set);
    FOSSIL_TEST_ADD(objcpp_clist_tofu_fixture, objcpp_test_clist_get_front_and_back);
    FOSSIL_TEST_ADD(objcpp_clist_tofu_fixture, objcpp_test_clist_set_front_and_back);
    FOSSIL_TEST_ADD(objcpp_clist_tofu_fixture, objcpp_test_clist_copy_and_move);
    FOSSIL_TEST_ADD(objcpp_clist_tofu_fixture, objcpp_test_clist_empty_and_null_checks);

    // Register the test group
    FOSSIL_TEST_REGISTER(objcpp_clist_tofu_fixture);
} // end of tests
