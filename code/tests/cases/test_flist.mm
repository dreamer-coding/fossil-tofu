...
FOSSIL_SUITE(objcpp_flist_tofu_fixture);

FOSSIL_SETUP(objcpp_flist_tofu_fixture) {
    // Setup the test fixture
}

FOSSIL_TEARDOWN(objcpp_flist_tofu_fixture) {
...
FOSSIL_TEST(objcpp_test_flist_create_and_destroy) {
    FList flist("i32");
...
FOSSIL_TEST(objcpp_test_flist_create_default) {
    FList flist;
    ASSUME_ITS_TRUE(flist.not_cnullptr());
    // Type check not available directly; assume default is "any".
}

FOSSIL_TEST(objcpp_test_flist_insert_and_size) {
    FList flist("i32");
    flist.insert("10");
    flist.insert("20");
    flist.insert("30");
...
FOSSIL_TEST(objcpp_test_flist_reverse_forward) {
    FList flist("i32");
    flist.insert("A");
    flist.insert("B");
    flist.insert("C");
...
// * * * * * * * * * * * * * * * * * * * * * * * *
FOSSIL_TEST_GROUP(objcpp_flist_tofu_tests) {    
    // flist ToFu Fixture
    FOSSIL_TEST_ADD(objcpp_flist_tofu_fixture, objcpp_test_flist_create_and_destroy);
    FOSSIL_TEST_ADD(objcpp_flist_tofu_fixture, objcpp_test_flist_create_default);
    FOSSIL_TEST_ADD(objcpp_flist_tofu_fixture, objcpp_test_flist_insert_and_size);
    FOSSIL_TEST_ADD(objcpp_flist_tofu_fixture, objcpp_test_flist_remove);
    FOSSIL_TEST_ADD(objcpp_flist_tofu_fixture, objcpp_test_flist_reverse_forward);
    FOSSIL_TEST_ADD(objcpp_flist_tofu_fixture, objcpp_test_flist_reverse_backward);
    FOSSIL_TEST_ADD(objcpp_flist_tofu_fixture, objcpp_test_flist_get_and_set);
    FOSSIL_TEST_ADD(objcpp_flist_tofu_fixture, objcpp_test_flist_get_front_and_back);
    FOSSIL_TEST_ADD(objcpp_flist_tofu_fixture, objcpp_test_flist_set_front_and_back);
    FOSSIL_TEST_ADD(objcpp_flist_tofu_fixture, objcpp_test_flist_copy_and_move);
    FOSSIL_TEST_ADD(objcpp_flist_tofu_fixture, objcpp_test_flist_empty_and_null_checks);

    // Register the test group
    FOSSIL_TEST_REGISTER(objcpp_flist_tofu_fixture);
} // end of tests
