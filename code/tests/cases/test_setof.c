...
FOSSIL_TEST_GROUP(c_setof_tofu_tests) {    
    ...
    FOSSIL_ADD_TEST(c_setof_tofu_fixture, c_test_setof_create_and_destroy);
    FOSSIL_ADD_TEST(c_setof_tofu_fixture, c_test_setof_create_default);
    FOSSIL_ADD_TEST(c_setof_tofu_fixture, c_test_setof_insert_and_contains);
    FOSSIL_ADD_TEST(c_setof_tofu_fixture, c_test_setof_remove);
    FOSSIL_ADD_TEST(c_setof_tofu_fixture, c_test_setof_copy_constructor);
    FOSSIL_ADD_TEST(c_setof_tofu_fixture, c_test_setof_move_constructor);
    FOSSIL_ADD_TEST(c_setof_tofu_fixture, c_test_setof_is_empty_and_not_empty);
    FOSSIL_ADD_TEST(c_setof_tofu_fixture, c_test_setof_insert_duplicate);
    FOSSIL_ADD_TEST(c_setof_tofu_fixture, c_test_setof_remove_nonexistent);
    FOSSIL_ADD_TEST(c_setof_tofu_fixture, c_test_setof_null_args);

    // Register the test group
    FOSSIL_ADD_SUITE(c_setof_tofu_fixture);
} // end of tests
