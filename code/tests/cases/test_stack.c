...
FOSSIL_TEST(c_test_stack_create_destroy) {
...
FOSSIL_TEST(c_test_stack_copy_constructor) {
...
FOSSIL_TEST(c_test_stack_move_constructor) {
    fossil_tofu_stack_t* stack1 = fossil_tofu_stack_create_container("i32");
...
FOSSIL_TEST(c_test_stack_top_and_get_set) {
    fossil_tofu_stack_t* stack = fossil_tofu_stack_create_container("i32");
...
FOSSIL_TEST(c_test_stack_empty_and_not_empty) {
    fossil_tofu_stack_t* stack = fossil_tofu_stack_create_container("i32");
...
FOSSIL_TEST(c_test_stack_size_null_stack) {
    size_t size = fossil_tofu_stack_size(NULL);
    ASSUME_ITS_EQUAL_I32(size, FOSSIL_TOFU_SUCCESS);
}

FOSSIL_TEST(c_test_stack_not_empty_and_is_empty_variants) {
    fossil_tofu_stack_t* stack = fossil_tofu_stack_create_container("i32");
...
FOSSIL_TEST(c_test_stack_not_cnullptr_and_is_cnullptr) {
    fossil_tofu_stack_t* stack = fossil_tofu_stack_create_container("i32");
...
FOSSIL_TEST(c_test_stack_top_empty_stack) {
    fossil_tofu_stack_t* stack = fossil_tofu_stack_create_container("i32");
    fossil_tofu_t top = fossil_tofu_stack_top(stack);
...
FOSSIL_TEST(c_test_stack_get_out_of_bounds) {
    fossil_tofu_stack_t* stack = fossil_tofu_stack_create_container("i32");
    fossil_tofu_stack_insert(stack, "1");
...
FOSSIL_TEST(c_test_stack_set_out_of_bounds) {
    fossil_tofu_stack_t* stack = fossil_tofu_stack_create_container("i32");
    fossil_tofu_stack_insert(stack, "1");
...
FOSSIL_TEST_GROUP(c_stack_tofu_tests) {    
    ...
    FOSSIL_ADD_TEST(c_stack_tofu_fixture, c_test_stack_create_destroy);
    FOSSIL_ADD_TEST(c_stack_tofu_fixture, c_test_stack_create_default);
    FOSSIL_ADD_TEST(c_stack_tofu_fixture, c_test_stack_insert_and_remove);
    FOSSIL_ADD_TEST(c_stack_tofu_fixture, c_test_stack_copy_constructor);
    FOSSIL_ADD_TEST(c_stack_tofu_fixture, c_test_stack_move_constructor);
    FOSSIL_ADD_TEST(c_stack_tofu_fixture, c_test_stack_top_and_get_set);
    FOSSIL_ADD_TEST(c_stack_tofu_fixture, c_test_stack_empty_and_not_empty);
    FOSSIL_ADD_TEST(c_stack_tofu_fixture, c_test_stack_insert_null_stack);
    FOSSIL_ADD_TEST(c_stack_tofu_fixture, c_test_stack_remove_null_stack);
    FOSSIL_ADD_TEST(c_stack_tofu_fixture, c_test_stack_remove_empty_stack);
    FOSSIL_ADD_TEST(c_stack_tofu_fixture, c_test_stack_size_null_stack);
    FOSSIL_ADD_TEST(c_stack_tofu_fixture, c_test_stack_not_empty_and_is_empty_variants);
    FOSSIL_ADD_TEST(c_stack_tofu_fixture, c_test_stack_not_cnullptr_and_is_cnullptr);
    FOSSIL_ADD_TEST(c_stack_tofu_fixture, c_test_stack_top_empty_stack);
    FOSSIL_ADD_TEST(c_stack_tofu_fixture, c_test_stack_get_out_of_bounds);
    FOSSIL_ADD_TEST(c_stack_tofu_fixture, c_test_stack_set_out_of_bounds);

    // Register the test group
    FOSSIL_ADD_SUITE(c_stack_tofu_fixture);
} // end of tests
