...
FOSSIL_TEST_CASE(cpp_test_queue_class_insert) {
    ...
    ASSUME_ITS_TRUE(queue.insert(fossil::tofu::Tofu("i32", "42")) == FOSSIL_TOFU_SUCCESS);
    ASSUME_ITS_TRUE(queue.size() == 1);
}

FOSSIL_TEST_CASE(cpp_test_queue_class_remove) {
    fossil::tofu::Queue queue("i32");
    queue.insert(fossil::tofu::Tofu("i32", "42"));
...
FOSSIL_TEST_CASE(cpp_test_queue_class_get_front) {
    fossil::tofu::Queue queue("i32");
    queue.insert(fossil::tofu::Tofu("i32", "42"));
    fossil::tofu::Tofu front = queue.get_front();
...
FOSSIL_TEST_CASE(cpp_test_queue_class_get_rear) {
    fossil::tofu::Queue queue("i32");
    queue.insert(fossil::tofu::Tofu("i32", "42"));
    fossil::tofu::Tofu rear = queue.get_rear();
    ASSUME_ITS_TRUE(rear.get_value() == "42");
}

FOSSIL_TEST_CASE(cpp_test_queue_class_set_front) {
    fossil::tofu::Queue queue("i32");
    queue.insert(fossil::tofu::Tofu("i32", "42"));
    queue.set_front(fossil::tofu::Tofu("i32", "84"));
    fossil::tofu::Tofu front = queue.get_front();
...
FOSSIL_TEST_CASE(cpp_test_queue_class_set_rear) {
    fossil::tofu::Queue queue("i32");
    queue.insert(fossil::tofu::Tofu("i32", "42"));
    queue.set_rear(fossil::tofu::Tofu("i32", "84"));
    fossil::tofu::Tofu rear = queue.get_rear();
    ASSUME_ITS_TRUE(rear.get_value() == "84");
}

FOSSIL_TEST_CASE(cpp_test_queue_class_copy_constructor) {
    fossil::tofu::Queue queue1("i32");
    queue1.insert(fossil::tofu::Tofu("i32", "42"));
    fossil::tofu::Queue queue2(queue1);
    ASSUME_ITS_TRUE(queue2.size() == 1);
    ASSUME_ITS_TRUE(queue2.get_front().get_value() == "42");
}

FOSSIL_TEST_CASE(cpp_test_queue_class_move_constructor) {
    fossil::tofu::Queue queue1("i32");
    queue1.insert(fossil::tofu::Tofu("i32", "42"));
    fossil::tofu::Queue queue2(std::move(queue1));
    ASSUME_ITS_TRUE(queue2.size() == 1);
    ASSUME_ITS_TRUE(queue2.get_front().get_value() == "42");
}
