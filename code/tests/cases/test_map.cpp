...
FOSSIL_TEST_CASE(cpp_test_map_create_default) {
...
FOSSIL_TEST_GROUP(cpp_tofu_map_tests) {
    FOSSIL_TEST_ADD(cpp_map_tofu_fixture, cpp_test_map_create_destroy);
    FOSSIL_TEST_ADD(cpp_map_tofu_fixture, cpp_test_map_create_default);
    FOSSIL_TEST_ADD(cpp_map_tofu_fixture, cpp_test_map_create_copy);
    FOSSIL_TEST_ADD(cpp_map_tofu_fixture, cpp_test_map_create_move);
    FOSSIL_TEST_ADD(cpp_map_tofu_fixture, cpp_test_map_insert_get);
