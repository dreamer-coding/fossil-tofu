...
FOSSIL_TEST_GROUP(cpp_generic_tofu_tests) {    
    ...
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_struct_create_destroy);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_struct_default);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_struct_copy_constructor);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_struct_move_constructor);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_struct_copy_assignment);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_struct_move_assignment);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_struct_set_value);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_struct_set_attribute);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_set_and_get_value);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_mutability);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_type_and_info);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_set_and_get_attribute);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_validate_type);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_create_invalid_type);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_compare_equal_and_not_equal);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_set_value_immutable);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_get_value_or_default);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_is_empty);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_clone);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_lock);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_as_from_i8);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_as_from_i16);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_as_from_i32);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_as_from_i64);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_as_from_u8);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_as_from_u16);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_as_from_u32);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_as_from_u64);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_as_from_hex);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_as_from_oct);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_as_from_bin);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_as_from_f32);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_as_from_f64);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_as_from_cstr);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_as_from_char);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_as_from_bool);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_as_from_size);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_as_from_datetime);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_as_from_duration);
    FOSSIL_ADD_TEST(cpp_generic_tofu_fixture, cpp_test_tofu_as_from_any);

    // Register the test group
    FOSSIL_ADD_SUITE(cpp_generic_tofu_fixture);
} // end of tests
