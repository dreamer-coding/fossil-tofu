...
FOSSIL_SUITE(objc_generiobjc_tofu_fixture);

FOSSIL_SETUP(objc_generiobjc_tofu_fixture) {
    // Setup the test fixture
}

FOSSIL_TEARDOWN(objc_generiobjc_tofu_fixture) {
...
FOSSIL_TEST(objc_test_tofu_struct_create_destroy) {
...
FOSSIL_TEST(objc_test_tofu_struct_default) {
...
FOSSIL_TEST(objc_test_tofu_struct_copy_constructor) {
...
FOSSIL_TEST(objc_test_tofu_struct_move_constructor) {
...
FOSSIL_TEST(objc_test_tofu_set_and_get_value) {
...
FOSSIL_TEST(objc_test_tofu_mutability) {
...
FOSSIL_TEST(objc_test_tofu_type_and_info) {
...
FOSSIL_TEST(objc_test_tofu_set_and_get_attribute) {
...
FOSSIL_TEST(objc_test_tofu_validate_type) {
...
FOSSIL_TEST(objc_test_tofu_set_value_null_and_immutable) {
...
FOSSIL_TEST(objc_test_tofu_set_attribute_null) {
    int result = fossil_tofu_set_attribute(NULL, "name", "desc", "id");
    ASSUME_ITS_EQUAL_I32(result, FOSSIL_TOFU_ERROR_NULL_POINTER);
}

FOSSIL_TEST(objc_test_tofu_get_attribute_null) {
    ASSUME_ITS_CNULL(fossil_tofu_get_attribute(NULL));
}

FOSSIL_TEST(objc_test_tofu_equals_null) {
    fossil_tofu_t tofu = fossil_tofu_create("i8", "1");
...
FOSSIL_TEST(objc_test_tofu_copy_null) {
    fossil_tofu_t tofu = fossil_tofu_create("i8", "1");
...
FOSSIL_TEST(objc_test_tofu_get_value_or_default) {
    fossil_tofu_t tofu = fossil_tofu_create("i8", "1");
...
FOSSIL_TEST(objc_test_tofu_is_empty) {
...
FOSSIL_TEST(objc_test_tofu_clone) {
    fossil_tofu_t tofu = fossil_tofu_create("i8", "1");
...
FOSSIL_TEST(objc_test_tofu_lock) {
    fossil_tofu_t tofu = fossil_tofu_create("i8", "1");
