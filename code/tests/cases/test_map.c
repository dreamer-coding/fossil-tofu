...
FOSSIL_TEST_CASE(c_test_map_insert) {
...
FOSSIL_TEST_CASE(c_test_map_get) {
    fossil_map_t* map = fossil_map_create_default();
    fossil_map_insert(map, "key1", "value1");
...
FOSSIL_TEST_CASE(c_test_map_insert_multiple) {
    fossil_map_t* map = fossil_map_create_default();
    ASSUME_ITS_TRUE(fossil_map_insert(map, "key1", "value1") == FOSSIL_TOFU_SUCCESS);
...
FOSSIL_TEST_CASE(c_test_map_erase_multiple) {
    fossil_map_t* map = fossil_map_create_default();
    fossil_map_insert(map, "key1", "value1");
    fossil_map_insert(map, "key2", "value2");
...
FOSSIL_TEST_GROUP(c_map_tofu_tests) {
    FOSSIL_TEST_ADD(c_map_tofu_fixture, c_test_map_insert);
    ...
    FOSSIL_TEST_ADD(c_map_tofu_fixture, c_test_map_get);
    FOSSIL_TEST_ADD(c_map_tofu_fixture, c_test_map_size);
    FOSSIL_TEST_ADD(c_map_tofu_fixture, c_test_map_insert_multiple);
    FOSSIL_TEST_ADD(c_map_tofu_fixture, c_test_map_erase_multiple);
