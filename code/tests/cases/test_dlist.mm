...
FOSSIL_SUITE(objcpp_dlist_tofu_fixture);

FOSSIL_SETUP(objcpp_dlist_tofu_fixture) {
    // Setup the test fixture
}

FOSSIL_TEARDOWN(objcpp_dlist_tofu_fixture) {
...
FOSSIL_TEST(objcpp_test_dlist_create_and_destroy) {
    DList dlist("i32");
...
FOSSIL_TEST(objcpp_test_dlist_create_default) {
    DList dlist;
    ASSUME_ITS_TRUE(dlist.not_cnullptr());
    // Default type is "any" in the C API, but not exposed in DList, so just check not null
}

FOSSIL_TEST(objcpp_test_dlist_insert_and_size) {
    DList dlist("i32");
...
FOSSIL_TEST(objcpp_test_dlist_remove) {
    DList dlist("i32");
    dlist.insert((char*)"1");
    dlist.insert((char*)"2");
    dlist.insert((char*)"3");
...
FOSSIL_TEST(objcpp_test_dlist_reverse_forward) {
    DList dlist("i32");
    dlist.insert((char*)"A");
    dlist.insert((char*)"B");
    dlist.insert((char*)"C");
...
FOSSIL_TEST(objcpp_test_dlist_reverse_backward) {
    DList dlist("i32");
    dlist.insert((char*)"X");
    dlist.insert((char*)"Y");
    dlist.insert((char*)"Z");
...
FOSSIL_TEST(objcpp_test_dlist_get_and_set) {
    DList dlist("i32");
...
FOSSIL_TEST(objcpp_test_dlist_get_front_and_back) {
    DList dlist("i32");
...
FOSSIL_TEST(objcpp_test_dlist_set_front_and_back) {
    DList dlist("i32");
...
FOSSIL_TEST(objcpp_test_dlist_copy_and_move) {
    DList dlist1("i32");
...
FOSSIL_TEST(objcpp_test_dlist_empty_and_null_checks) {
    DList* dlist = nullptr;
...
// * * * * * * * * * * * * * * * * * * * * * * * *
FOSSIL_TEST_GROUP(objcpp_dlist_tofu_tests) {    
    // dlist ToFu Fixture
    FOSSIL_TEST_ADD(objcpp_dlist_tofu_fixture, objcpp_test_dlist_create_and_destroy);
    FOSSIL_TEST_ADD(objcpp_dlist_tofu_fixture, objcpp_test_dlist_create_default);
    FOSSIL_TEST_ADD(objcpp_dlist_tofu_fixture, objcpp_test_dlist_insert_and_size);
    FOSSIL_TEST_ADD(objcpp_dlist_tofu_fixture, objcpp_test_dlist_remove);
    FOSSIL_TEST_ADD(objcpp_dlist_tofu_fixture, objcpp_test_dlist_reverse_forward);
    FOSSIL_TEST_ADD(objcpp_dlist_tofu_fixture, objcpp_test_dlist_reverse_backward);
    FOSSIL_TEST_ADD(objcpp_dlist_tofu_fixture, objcpp_test_dlist_get_and_set);
    FOSSIL_TEST_ADD(objcpp_dlist_tofu_fixture, objcpp_test_dlist_get_front_and_back);
    FOSSIL_TEST_ADD(objcpp_dlist_tofu_fixture, objcpp_test_dlist_set_front_and_back);
    FOSSIL_TEST_ADD(objcpp_dlist_tofu_fixture, objcpp_test_dlist_copy_and_move);
    FOSSIL_TEST_ADD(objcpp_dlist_tofu_fixture, objcpp_test_dlist_empty_and_null_checks);

    // Register the test group
    FOSSIL_TEST_REGISTER(objcpp_dlist_tofu_fixture);
} // end of tests
