...
FOSSIL_TEST_GROUP(c_cqueue_tofu_tests) {    
    ...
    FOSSIL_ADD_TEST(c_cqueue_tofu_fixture, c_test_cqueue_create_container_and_destroy);
    FOSSIL_ADD_TEST(c_cqueue_tofu_fixture, c_test_cqueue_create_default_and_destroy);
    FOSSIL_ADD_TEST(c_cqueue_tofu_fixture, c_test_cqueue_insert_and_remove);
    FOSSIL_ADD_TEST(c_cqueue_tofu_fixture, c_test_cqueue_create_copy);
    FOSSIL_ADD_TEST(c_cqueue_tofu_fixture, c_test_cqueue_create_move);
    FOSSIL_ADD_TEST(c_cqueue_tofu_fixture, c_test_cqueue_not_empty_and_is_empty);
    FOSSIL_ADD_TEST(c_cqueue_tofu_fixture, c_test_cqueue_not_cnullptr_and_is_cnullptr);
    FOSSIL_ADD_TEST(c_cqueue_tofu_fixture, c_test_cqueue_set_front_and_set_rear);
    FOSSIL_ADD_TEST(c_cqueue_tofu_fixture, c_test_cqueue_get_front_and_get_rear_empty);
    FOSSIL_ADD_TEST(c_cqueue_tofu_fixture, c_test_cqueue_remove_empty);
    FOSSIL_ADD_TEST(c_cqueue_tofu_fixture, c_test_cqueue_size_consistency);

    // Register the test group
    FOSSIL_ADD_SUITE(c_cqueue_tofu_fixture);
} // end of tests
